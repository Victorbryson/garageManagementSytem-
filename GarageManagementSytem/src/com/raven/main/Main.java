...
import com.raven.form.Services;
import com.raven.form.CarEntry;
import com.raven.event.EventMenu;
import com.raven.form.CarsDone;
import com.raven.form.Employee;
import com.raven.form.ExistingCars;
import com.raven.form.Form1;
import com.raven.form.Form2;
import com.raven.form.Form_Home;
import com.raven.form.MarkAsDone;
import com.raven.form.Stock;
        ...
        menu1.addEvent(new EventMenu() {
            ...
            public void menuIndexChange(int index) {
                if (index == 0) {
                    ...
                    showForm(new Services());
                }
                else if (index == 3) {
                    showForm(new Employee());
                }
                else if (index == 4) {
                    showForm(new CarEntry());
                }
                else if (index == 5) {
                    showForm(new ExistingCars());
                }
                else if (index == 6) {
                    showForm(new MarkAsDone());
                }
                 else if (index == 7) {
                    showForm(new CarsDone());
                }
            }
        });
