...
public class Menu extends PanelShadow {
    ...
    private void initData() {
        ...
        listMenu.addItem(new Model_Menu("2", "Customers", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("3", "Stock Item", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("4", "Employee", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("5", "Entry Cars", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("6", "Existing Cars", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("7", "Stock Report", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("8", "Profit Report", Model_Menu.MenuType.MENU));
